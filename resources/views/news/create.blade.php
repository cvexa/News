...
@section('content')
  ...
  <div class="col-md-12 users-table">
     @if (!empty(Session::get('success')))
                ...
                @endif
 				<form action="{{route('news.store')}}" method="POST" class="col-md-12" id="create_story" name="create_story" enctype="multipart/form-data">
                    {{ csrf_field() }}
	            ...
	            <div class="col-md-8 text-center create-story-wrapper">
	                ...
	                <p>
	                    ...
	                    <label for="picture-story-title">
	                        <img src="{{asset('/images/no-photo.png')}}" alt="course-pic" id="story-picture">
	                        <br>
	                    </label>
	                </div>
	                ...
	                <p>
	                    ...
	                    <input type="text" id="sub_title" name="sub_title" placeholder=""  value="{{old('sub_title')}}">
	                </p>

	                <p>
                        <label for="description">Description</label><br>
                        <textarea id="description" cols="30" rows="5" name="description" placeholder="">{{old('description')}}</textarea>
                    </p>
